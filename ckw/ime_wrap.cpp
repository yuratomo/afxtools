...
typedef BOOL (WINAPI* FN_SetOpenStatus)(HIMC, BOOL);
...
static FN_SetOpenStatus		fn_SetOpenStatus	= NULL;
...
BOOL WINAPI ImmSetOpenStatus(HIMC imc, BOOL stat)
{
	if(fn_SetOpenStatus)
		return( fn_SetOpenStatus(imc, stat) );
	return(FALSE);
}
